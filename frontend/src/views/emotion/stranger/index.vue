<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <!-- <el-form-item label="姓名" prop="imageName">
          <el-input
    ...
    >
      ...
      <el-table-column label="摄像头编号" align="center" prop="cameraIp" />
      <el-table-column label="情绪" align="center" prop="emotion">
...
// 获取陌生人员信息接口
import { getStrangerInfo } from "@/api/stranger";
...
export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
      // 判断 dateRange 是否有效，如果无效则设置为 null
      this.queryParams.beginTime = this.dateRange && this.dateRange[0] ? this.dateRange[0] : null;
      this.queryParams.endTime = this.dateRange && this.dateRange[1] ? this.dateRange[1] : null;

      getStrangerInfo(this.queryParams).then((response) => {
