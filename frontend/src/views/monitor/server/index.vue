  ...
  <div class="app-container">
    <el-row>
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          <div slot="header">
            <span><i class="el-icon-coffee-cup"></i> Python运行时信息</span>
          </div>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;table-layout:fixed;">
              <tbody>
                ...
                <tr>
                  <td colspan="1" class="el-table__cell is-leaf"><div class="cell">内存使用</div></td>
                  <td colspan="3" class="el-table__cell is-leaf"><div class="cell" v-if="server.py">{{ server.py.used }} / {{ server.py.total }} ({{ server.py.usage }}%)</div></td>
                </tr>
              </tbody>
            </table>
          </div>
