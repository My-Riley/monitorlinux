    ...
    if (!window.WebVideoCtrl) {
        var e = (function () {
            ...
            function r(e) {
                ...
                if (e && t.test(e)) {
                    if (4 === e.length) {
                        for (var n = "#", r = 1; 4 > r; r += 1)
                            n += e.slice(r, r + 1).concat(e.slice(r, r + 1));
                        e = n;
                    }
                    for (var s = [], r = 1; 7 > r; r += 2)
                        s.push(parseInt("0x" + e.slice(r, r + 2)));
                    return "[" + s.join(",") + ",0.6]";
                }
                return e;
            }
            function s() {
                return void 0 !== s.unique
                    ? s.unique
                    : ((this.szIP = ""),
                        (this.szHostName = ""),
                        (this.szAuth = ""),
            ...
            (window.GetSelectWndInfo = function (e) {
                if (ct()) {
                    ...
                    var n = [];
                    n.push("<RealPlayInfo>"),
                        n.push("<SelectWnd>" + e + "</SelectWnd>"),
                        n.push("</RealPlayInfo>"),
                        d.cbSelWnd && d.cbSelWnd(S.loadXML(n.join("")));
                } else {
                    var r = S.loadXML(e);
                    if (t.$XML(r).find("SelectWnd", !0).length > 0) {
                        (f = parseInt(t.$XML(r).find("SelectWnd").eq(0).text(), 10)),
                            null === g && Y();
                        var n = [];
                        n.push("<RealPlayInfo>"),
                            n.push("<SelectWnd>" + f + "</SelectWnd>"),
                            n.push("</RealPlayInfo>"),
                            d.cbSelWnd && d.cbSelWnd(S.loadXML(n.join("")));
                    } else if (t.$XML(r).find("DoubleClickWnd", !0).length > 0) {
                        var s = parseInt(
                            t.$XML(r).find("DoubleClickWnd").eq(0).text(),
                            10
                        );
                        (h = "0" === t.$XML(r).find("IsFullScreen").eq(0).text()),
                            d.cbDoubleClickWnd && d.cbDoubleClickWnd(s, h);
                    }
                }
            }),
                ...
                (window.PluginEventHandler = function (e, t, n) {
                    ct()
                        ? d.cbEvent && d.cbEvent(e, t, n)
                        : (w == t || G == t
                            ? y.I_Stop(e)
                            : X == t
                                ? y.I_StopRecord(e)
                                : W == t && y.I_StopVoiceTalk(),
                            d.cbEvent && d.cbEvent(t, e, n));
                }),
                ...
                (window.KeyBoardEventInfo = function (e) {
                    100 === parseInt(e, 10) &&
                        ((h = !1), d.cbDoubleClickWnd && d.cbDoubleClickWnd(f, h));
                });
            var N = function () {
                if (d.bDebugMode) {
                    var e = F(arguments);
                ...
                J = function (e, n, r) {
                    y.I_GetSecurityVersion(e, {
                        success: function (e) {
                            (oSecurityCap.iKeyIterateNum = parseInt(
                                t.$XML(e).find("keyIterateNum").eq(0).text(),
                                10
                            )),
                                (oSecurityCap.oIrreversibleEncrypt = {
                                    bSupport:
                                        "true" === t.$XML(e).find("isIrreversible").eq(0).text(),
                ...
                K = function () {
                    ...
                    if (S.browser().msie)
                        ...
                        for (var t = navigator.mimeTypes.length, n = 0; t > n; n++)
                            navigator.mimeTypes[n].type.toLowerCase() == d.szMimeTypes &&
                                (e =
                    ...
                    y.I_GetDeviceInfo(e.szIP, {
                        ...
                        y.I_GetAudioInfo(e.szIP, {
                            success: function (n) {
                                ...
                                (e.m_iAudioBitRate =
                                    "" !== t.$XML(n).find("audioBitRate").eq(0).text()
                                        ? 1e3 *
                                        parseInt(
                                            t.$XML(n).find("audioBitRate").eq(0).text(),
                                            10
                                    ...
                                    (e.m_iAudioSamplingRate =
                                        "" !== t.$XML(n).find("audioSamplingRate").eq(0).text()
                                            ? 1e3 *
                                            parseInt(
                                                t.$XML(n).find("audioSamplingRate").eq(0).text(),
                                                10
                ...
                nt = function (e) {
                    ...
                    if (it(e)) (s = rt(e)), (t = s.iRtspPort), (r = s.iDevicePort);
                        ...
                        i
                            ? (s = rt(e))
                            : ((s = st(e)),
                                -1 == s.iRtspPort && -1 == s.iDevicePort && (s = rt(e))),
                            (t = s.iRtspPort),
                            (n = s.iHttpPort),
                            (r = s.iDevicePort);
                    }
                ...
                rt = function (e) {
                    ...
                    return (
                                ...
                                for (var i = 0, a = o.length; a > i; i++)
                                    "rtsp" ===
                                        t
                                            ...
                                            .toLowerCase() &&
                                        (n = parseInt(
                                            t.$XML(o).eq(i).find("portNo").eq(0).text(),
                                            10
                                        )),
                                        "http" ===
                                        t
                        ...
                        { iRtspPort: n, iHttpPort: r, iDevicePort: s }
                    );
                },
                st = function (e) {
                    var n = -1,
                    ...
                    return (
                        e.oProtocolInc.getUPnPPortStatus(e, {
                            ...
                            success: function (e) {
                                for (
                                    var o = t.$XML(e).find("portStatus", !0),
                                    i = 0,
                                    a = o.length;
                                    a > i;
                                    i++
                                    ...
                                    "rtsp" ==
                                        t
                                            ...
                                            .toLowerCase() &&
                                        (n = parseInt(
                                            t.$XML(o).eq(i).find("externalPort").eq(0).text(),
                                            10
                                        )),
                                        "http" ==
                                        t
                ...
                ot = function (e) {
                    ...
                    return (
                        e.oProtocolInc.getNetworkBond(e, {
                            async: !1,
                            success: function (r) {
                                "true" == t.$XML(r).find("enabled").eq(0).text()
                                    ? n.push({
                                    ...
                                    : e.oProtocolInc.getNetworkInterface(e, {
                                        ...
                                        success: function (e) {
                                            for (
                                                var r = t.$XML(e).find("NetworkInterface", !0),
                                                s = 0,
                                                o = r.length;
                                                o > s;
                                                s++
                ...
                it = function (e) {
                    ...
                    return (
                        e.oProtocolInc.getPPPoEStatus(e, {
                            ...
                            success: function (e) {
                                n =
                                    t.$XML(e).find("ipAddress", !0).length > 0
                                        ? !0
                                        : t.$XML(e).find("ipv6Address", !0).length > 0
                                            ? !0
                                            : !1;
                            },
                            error: function () {
                            ...
                            success: function (n) {
                                (e.oStreamCapa.bObtained = !0),
                                    (e.oStreamCapa.bSupportShttpPlay =
                                        "true" ===
                                        t.$XML(n).find("isSupportHttpPlay").eq(0).text()),
                                    (e.oStreamCapa.bSupportShttpPlayback =
                                        "true" ===
                                        t.$XML(n).find("isSupportHttpPlayback").eq(0).text()),
                                    (e.oStreamCapa.bSupportShttpsPlay =
                                        "true" ===
                                        t.$XML(n).find("isSupportHttpsPlay").eq(0).text()),
                                    (e.oStreamCapa.bSupportShttpsPlayback =
                                        "true" ===
                                        t.$XML(n).find("isSupportHttpsPlayback").eq(0).text()),
                                    ...
                                    (e.oStreamCapa.iIpChanBase =
                                        t.$XML(n).find("ipChanBase", !0).length > 0
                                            ? parseInt(
                                                t.$XML(n).find("ipChanBase").eq(0).text(),
                                                10
                                            )
                                            : 1);
                            },
                ...
                ct = function () {
                    if (d.bNoPlugin) {
                        var e = S.browser();
                        return (e.chrome && parseInt(e.version, 10) > 45) ||
                ...
                lt = function (e) {
                    ...
                    return (
                        d.proxyAddress &&
                        ((t = d.proxyAddress.ip), (n = d.proxyAddress.port)),
                        /^(http|https):\/\/([^\/]+)(.+)$/.test(e) &&
                        (e = e.replace(RegExp.$2, t + ":" + n)),
                        S.cookie("webVideoCtrlProxy", RegExp.$2, { raw: !0 }),
                        e
                    );
                },
                dt = function (e) {
                    ...
                    return (
                        /^(ws):\/\/([^\/:]+):(\d+)\/(.+)$/.test(e) &&
                        (e = e.replace(RegExp.$2 + ":" + RegExp.$3, t + ":" + n)),
                        e.indexOf("ws") > -1
                            ? S.cookie("webVideoCtrlProxyWs", RegExp.$2 + ":" + RegExp.$3, {
                                raw: !0,
                            })
                            : S.cookie(
                        ...
                        S.cookie("webVideoCtrlProxyWsChannel", RegExp.$4, { raw: !0 }),
            ...
            (this.I_SupportNoPlugin = function () {
                        ...
                        r &&
                            (("object" == typeof exports && "undefined" != typeof module) ||
                                ("function" == typeof define && define.amd
                                    ? require([r + "/jsPlugin-1.2.0.min.js"], function (e) {
                                        (window.JSPlugin = e.JSPlugin),
                ...
                (this.I_InsertOBJECTPlugin = function (e) {
                    if (
                        (U(e) || (d.szContainerID = e),
                            null == document.getElementById(d.szContainerID))
                    )
                        return -1;
                    if (
                        null != document.getElementById(c) ||
                        0 != document.getElementsByName(c).length
                    )
                        return -1;
                    if (ct()) {
                        var t = {
                        ...
                        if ("" != n) {
                            for (
                                var r = {}, s = n.split(";"), o = "", i = 0, f = s.length;
                                f > i;
                                i++
                            )
                                (o = s[i]),
                                    o.indexOf("sub-background") > -1
                                        ? (r.background = "#" + o.split(":")[1])
                                        : o.indexOf("sub-border-select") > -1
                                            ? (r.borderSelect = "#" + o.split(":")[1])
                                            : o.indexOf("sub-border") > -1 &&
                                            (r.border = "#" + o.split(":")[1]);
                            t.oStyle = r;
                        }
                        p = new JSPlugin(t);
                    } else
                        (document.getElementById(d.szContainerID).innerHTML = K()),
                            (p = S.browser().msie
                                ? document.getElementById(c)
                                : document.getElementsByName(l)[0]);
                    return null == p && null == p.object
                        ? -1
                        : ("object" == typeof window.attachEvent &&
                            S.browser().msie &&
                            (p.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
                                p.attachEvent("ZoomInfoCallback", ZoomInfoCallback),
                                p.attachEvent("GetHttpInfo", GetHttpInfo),
                                p.attachEvent("PluginEventHandler", PluginEventHandler),
                                p.attachEvent("RemoteConfigInfo", RemoteConfigInfo),
                                p.attachEvent("KeyBoardEventInfo", KeyBoardEventInfo)),
                            Y(),
                            0);
                }),
                ...
                (this.I2_OpenFileDlg = function (e) {
                    ...
                    return (
                        ct()
                            ? p.JS_OpenFileBrowser(e, "").then(function (t) {
                                null != t
                                    ? 1 == e
                                        ? t.length > 100 && n.resolve(-1)
                                        : t.length > 130 && n.resolve(-1)
                                    : n.resolve(),
                                    n.resolve(t);
                            })
                            : ((t = p.HWP_OpenFileBrowser(e, "")),
                                null != t
                                    ? 1 == e
                                        ? t.length > 100 && n.resolve(-1)
                                        : t.length > 130 && n.resolve(-1)
                ...
                (this.I_GetLocalCfg = function () {
                    ...
                    return (
                        ...
                        r.push(
                            "<ProtocolType>" +
                            t.$XML(g).find("ProtocolType").eq(0).text() +
                            "</ProtocolType>"
                        ),
                        r.push(
                            "<PackgeSize>" +
                            t.$XML(g).find("PackgeSize").eq(0).text() +
                            "</PackgeSize>"
                        ),
                        r.push(
                            "<PlayWndType>" +
                            t.$XML(g).find("PlayWndType").eq(0).text() +
                            "</PlayWndType>"
                        ),
                        r.push(
                            "<BuffNumberType>" +
                            t.$XML(g).find("BuffNumberType").eq(0).text() +
                            "</BuffNumberType>"
                        ),
                        r.push(
                            "<RecordPath>" +
                            t.$XML(g).find("RecordPath").eq(0).text() +
                            "</RecordPath>"
                        ),
                        r.push(
                            "<CapturePath>" +
                            t.$XML(g).find("CapturePath").eq(0).text() +
                            "</CapturePath>"
                        ),
                        r.push(
                            "<PlaybackFilePath>" +
                            t.$XML(g).find("PlaybackFilePath").eq(0).text() +
                            "</PlaybackFilePath>"
                        ),
                        r.push(
                            "<PlaybackPicPath>" +
                            t.$XML(g).find("PlaybackPicPath").eq(0).text() +
                            "</PlaybackPicPath>"
                        ),
                        r.push(
                            "<DeviceCapturePath>" +
                            t.$XML(g).find("DeviceCapturePath").eq(0).text() +
                            "</DeviceCapturePath>"
                        ),
                        r.push(
                            "<DownloadPath>" +
                            t.$XML(g).find("DownloadPath").eq(0).text() +
                            "</DownloadPath>"
                        ),
                        r.push(
                            "<IVSMode>" +
                            t.$XML(g).find("IVSMode").eq(0).text() +
                            "</IVSMode>"
                        ),
                        r.push(
                            "<CaptureFileFormat>" +
                            t.$XML(g).find("CaptureFileFormat").eq(0).text() +
                            "</CaptureFileFormat>"
                        ),
                        r.push("</LocalConfigInfo>"),
                        (e = S.loadXML(r.join("")))
                ...
                (this.I_SetLocalCfg = function (e) {
                    ...
                    return (
                        t
                            ...
                            .find("ProtocolType")
                            .eq(0)
                            .text(t.$XML(n).find("ProtocolType").eq(0).text()),
                        t
                            .$XML(g)
                            .find("PackgeSize")
                            .eq(0)
                            .text(t.$XML(n).find("PackgeSize").eq(0).text()),
                        t
                            .$XML(g)
                            .find("PlayWndType")
                            .eq(0)
                            .text(t.$XML(n).find("PlayWndType").eq(0).text()),
                        t
                            .$XML(g)
                            .find("BuffNumberType")
                            .eq(0)
                            .text(t.$XML(n).find("BuffNumberType").eq(0).text()),
                        t
                            .$XML(g)
                            .find("RecordPath")
                            .eq(0)
                            .text(t.$XML(n).find("RecordPath").eq(0).text()),
                        t
                            .$XML(g)
                            .find("CapturePath")
                            .eq(0)
                            .text(t.$XML(n).find("CapturePath").eq(0).text()),
                        t
                            .$XML(g)
                            .find("PlaybackFilePath")
                            .eq(0)
                            .text(t.$XML(n).find("PlaybackFilePath").eq(0).text()),
                        t
                            .$XML(g)
                            .find("DeviceCapturePath")
                            .eq(0)
                            .text(t.$XML(n).find("DeviceCapturePath").eq(0).text()),
                        t
                            .$XML(g)
                            .find("PlaybackPicPath")
                            .eq(0)
                            .text(t.$XML(n).find("PlaybackPicPath").eq(0).text()),
                        t
                            .$XML(g)
                            .find("DownloadPath")
                            .eq(0)
                            .text(t.$XML(n).find("DownloadPath").eq(0).text()),
                        t
                            .$XML(g)
                            .find("IVSMode")
                            .eq(0)
                            .text(t.$XML(n).find("IVSMode").eq(0).text()),
                        t
                            .$XML(g)
                            .find("CaptureFileFormat")
                            .eq(0)
                            .text(t.$XML(n).find("CaptureFileFormat").eq(0).text()),
                        (r = p.HWP_SetLocalConfig(S.toXMLStr(g))),
                        r ? 0 : -1
                    );
                });
            var ft = function (e, t, n, r, o, i, a) {
                var u = { protocol: t, success: null, error: null };
                S.extend(u, a),
                    S.extend(u, {
                        success: function (u) {
                            var c = new s();
                            (c.szIP = e),
                                ...
                                tt(),
                                et(c),
                                P.push(jQuery.extend({}, c)),
                                a.success && a.success(u);
                        },
                        error: function (e, t) {
                            a.error && a.error(e, t);
                        },
            ...
            (this.getAuthType = function (e, n, r, s, o, i) {
                ...
                (this.setDeviceInfo = function (e, t, n, r, o) {
                    ...
                    return (
                        (t.szIP = n),
                        2 == r
                            ? ((t.szHttpProtocol = "https://"), (t.iHttpsPort = o))
                            : ((t.szHttpProtocol = "http://"), (t.iHttpPort = o)),
                        (t.iCGIPort = o),
                        (t.szDeviceIdentify = n + "_" + o),
                        (t.iDeviceProtocol = x),
                        (t.oProtocolInc = e),
                        t
                    );
                ...
                (this.successV1cb = function (e, n, r, s, o, i, a, u) {
                    (n = this.setDeviceInfo(e, n, r, s, o)),
                        (n.szAuth = t.$XML(i).find("sessionID").eq(0).text()),
                        Q(n),
                        N("使用%s协议登录成功", x),
                        J(n.szDeviceIdentify, a, u),
                        (n.sessionFailed = 0),
                        et(n);
                    var c = jQuery.extend({}, n);
                    P.push(c),
                        (c.sesstionTimer = setInterval(function () {
                            e.sessionHeartbeat(
                                c,
                                function () {
                                    c.sessionFailed = 0;
                                ...
                                function () {
                                    c.sessionFailed++,
                                        c.sessionFailed >= 5 &&
                                        (window.PluginEventHandler(null, _, c.szDeviceIdentify),
                                            clearInterval(c.sesstionTimer));
                                }
                            );
                        }, 3e4));
                }),
                (this.successV2cb = function (e, t, n, r, s, o, i, a) {
                    (t = this.setDeviceInfo(e, t, n, r, s)),
                        (t.szAuth = O(t, t.szDeviceIdentify)),
                        Q(t),
                        N("使用%s协议登录成功", x),
                        (document.cookie = "domain='10.18.99.194';path=/;"),
                        et(t),
                        J(t.szDeviceIdentify, i, a),
                        (t.sessionFailed = 0);
                    var u = jQuery.extend({}, t);
                    P.push(u),
                        (u.sesstionTimer = setInterval(function () {
                            e.sessionHeartbeat(
                                u,
                                function () {
                                    u.sessionFailed = 0;
                                ...
                                function () {
                                    u.sessionFailed++,
                                        u.sessionFailed >= 5 &&
                                        (window.PluginEventHandler(null, _, u.szDeviceIdentify),
                                            clearInterval(u.sesstionTimer));
                                }
                            );
                        }, 3e4));
                }),
                        ...
                        S.extend(c, {
                            success: function (c) {
                                ...
                                S.extend(l, {
                                    success: function (c) {
                                        a.success &&
                                            (a.success(c), u.successV1cb(e, t, n, r, s, c, i, o));
                                    },
                                    error: function (e, t) {
                                        a.error && a.error(e, t);
                                    },
                        ...
                        if (x == l) {
                            ...
                            this.getAuthType(d, e, t, n, r, function () {
                                ...
                                if (s > 2) i.error && i.error(s);
                                    ...
                                    var u = MD5(new Date().getTime().toString()).substring(
                                        0,
                                        8
                                    );
                                    u = parseInt(u.replace("#", ""), 16)
                                        .toString()
                                        .substring(0, 8);
                                    ...
                                    error: function (s, a) {
                                        ...
                                        S.extend(u, i),
                                            S.extend(u, {
                                                error: function () {
                                                    if (!U(i.cgi))
                                                        return i.error && i.error(s, a), void 0;
                                                    (p = S.Base64.encode(":" + r + ":" + o)),
                                                        (l = D),
                                                        (c = C);
                                                    var u = { success: null, error: null };
                ...
                (this.I_StartRealPlay = function (e, n) {
                    ...
                    if ((S.extend(l, n), -1 != r)) {
                        ...
                        var d = P[r];
                        if (ct()) {
                            if (!d.bSupportWebsocket)
                                return n.error && n.error(403, pt()), void 0;
                            s = d.oProtocolInc.CGI.startWsRealPlay;
                            var p = location.protocol;
                            (o = /^(https)(.*)$/.test(p) ? "wss://" : "ws://"),
                                (d.iWSPort = U(l.iWSPort) ? 7681 : l.iWSPort),
                                (i = d.iWSPort),
                                (u = l.iStreamType),
                                (a =
                                    l.iChannelID <= d.iAnalogChannelNum
                                        ? l.iChannelID
                                        : d.oStreamCapa.iIpChanBase +
                                        parseInt(l.iChannelID, 10) -
                                        d.iAnalogChannelNum -
                                        1),
                                (c = !0);
                        } else {
                            ...
                            h == H && d.oStreamCapa.bSupportShttpPlay
                                ? (N("SHTTP RealPlay"),
                                    (s = d.oProtocolInc.CGI.startShttpRealPlay),
                                    (o = "http://"),
                                    (u = l.iStreamType - 1),
                                    (a =
                                        l.iChannelID <= d.iAnalogChannelNum
                                    ...
                                    (c = !0),
                                    U(l.iPort)
                                        ? "https://" == d.szHttpProtocol
                                            ? (-1 == d.iHttpPort && (d.iHttpPort = nt(d).iHttpPort),
                                                (i = d.iHttpPort))
                                            : (i = d.iCGIPort)
                                        : ((d.iHttpPort = l.iPort), (i = l.iPort)))
                                : (N("RTSP RealPlay"),
                                    (s = d.oProtocolInc.CGI.startRealPlay),
                                    (o = "rtsp://"),
                                    (u = l.iStreamType),
                                    (a = l.iChannelID),
                                    U(l.iRtspPort) || (d.iRtspPort = l.iRtspPort),
                                    -1 == d.iRtspPort && (d.iRtspPort = nt(d).iRtspPort),
                                    (i = d.iRtspPort));
                        }
                        if (-1 == i)
                            return N("获取端口号失败"), n.error && n.error(), void 0;
                        S.extend(l, {
                            urlProtocol: o,
                            cgi: s,
                            iPort: i,
                        ...
                        var m = this;
                        -1 == r &&
                            d.oProtocolInc.startRealPlay(d, l).then(
                                function () {
                ...
                (this.I_Stop = function (e) {
                    ...
                    if (-1 != n) {
                        var r = I[n];
                        if (
                            (r.bRecord && (ct() || p.HWP_StopSave(r.iIndex)),
                                r.bSound && (ct() || p.HWP_CloseSound()),
                                r.bEZoom && (ct() || p.HWP_DisableZoom(r.iIndex)),
                                ct())
                        )
                            p.JS_Stop(t.iWndIndex).then(
                                function () {
                                    I.splice(n, 1), t.success && t.success();
                                },
                                function () {
                                    t.error && t.error();
                                }
                ...
                (this.I_OpenSound = function (e) {
                    ...
                    if (-1 != t) {
                        var r = I[t];
                        r.bSound ||
                            ((n = ct() ? p.JS_OpenSound(e) : p.HWP_OpenSound(e)),
                                0 == n && (r.bSound = !0));
                    }
                    return n;
                }),
                (this.I_CloseSound = function (e) {
                    ...
                    if (-1 != t) {
                        var r = I[t];
                        r.bSound &&
                            ((n = ct() ? p.JS_CloseSound() : p.HWP_CloseSound()),
                                0 == n && (r.bSound = !1));
                    }
                    return n;
                }),
                (this.I_SetVolume = function (e, t) {
                    ...
                    return (
                        -1 != r &&
                        (ct()
                            ? (p.JS_SetVolume(t, e), (n = 0))
                            : (n = p.HWP_SetVolume(t, e))),
                        n
                    );
                }),
                (this.I2_CapturePic = function (e, t) {
                    var n = { iWndIndex: f, bDateDir: !0 };
                        ...
                        if (ct()) {
                            ...
                            ".jpg" === e.slice(-4).toLowerCase()
                                ...
                                : ".jpeg" === e.slice(-5).toLowerCase()
                                    ...
                                    ((e = e.slice(0, -4)), (i = "BMP")),
                                p.JS_CapturePicture(n.iWndIndex, e, i).then(
                                    function () {
                                        o.resolve();
                                    },
                                    function () {
                            ...
                            ".jpg" === e.slice(-4).toLowerCase()
                                ...
                                : ".jpeg" === e.slice(-5).toLowerCase() &&
                                (e = e.slice(0, -5)),
                                (s = p.HWP_CapturePicture(n.iWndIndex, e, n.bDateDir)),
                                0 === s ? o.resolve() : o.reject();
                    else o.reject();
                    return o;
                }),
                (this.I2_CapturePicData = function (e) {
                    var t = { iWndIndex: f, bDateDir: !0 };
                    j(e) ? S.extend(t, e) : U(e) || (t.iWndIndex = e);
                    var n = this.findWndIndexByIndex(t.iWndIndex);
                    if (-1 != n) {
                        var r = $.Deferred();
                        ct()
                            ? p.JS_CapturePictureData(t.iWndIndex).then(
                                function (e) {
                                    r.resolve(e);
                                },
                                function (e) {
                ...
                (this.I_StartRecord = function (e, t) {
                    ...
                    if (-1 != r) {
                        ...
                        if (s.bRecord) n.error && n.error();
                            ...
                            var o = S.browser();
                            o.chrome
                                ? p.JS_StartSave(n.iWndIndex, e).then(
                                    function () {
                    ...
                    if (-1 != n) {
                        ...
                        if (r.bRecord)
                            if (ct()) {
                                var s = S.browser();
                                s.chrome
                                    ? p.JS_StopSave(t.iWndIndex).then(
                                        function () {
                ...
                (this.I_StartVoiceTalk = function (e, t) {
                    ...
                    if (-1 != n) {
                        var s = P[n];
                        s.bVoiceTalk ||
                            ((r = ct() ? -1 : s.oProtocolInc.startVoiceTalk(s, t)),
                                0 == r && (P[n].bVoiceTalk = !0));
                    }
                    return r;
                }),
                ...
                (this.I_PTZControl = function (e, t, n) {
                    var r = { iWndIndex: f, iPTZIndex: e, iPTZSpeed: 4 };
                    S.extend(r, n), S.extend(r, { async: !1 });
                ...
                (this.I_EnableEZoom = function (e) {
                    ...
                    if (-1 != t) {
                        var r = I[t];
                        r.bEZoom ||
                            ((n = ct() ? p.JS_EnableZoom(e) : p.HWP_EnableZoom(e, 0)),
                                0 == n && (r.bEZoom = !0));
                    }
                    return n;
                }),
                (this.I_DisableEZoom = function (e) {
                    ...
                    if (-1 != t) {
                        ...
                        r.bEZoom &&
                            (ct()
                                ? (n = p.JS_DisableZoom(e))
                                : (p.HWP_DisableZoom(e), (n = 0)),
                                0 == n && (r.bEZoom = !1));
                    }
                    return n;
                }),
                (this.I_Enable3DZoom = function (e) {
                    ...
                    if (-1 != t) {
                        ...
                        r.b3DZoom ||
                            (ct()
                                ? ((n = 0),
                                    p.JS_Enable3DZoom(e, function (e) {
                                        window.ZoomInfoCallback(e);
                                    }))
                                : (n = p.HWP_EnableZoom(e, 1)),
                                0 == n && (r.b3DZoom = !0));
                    }
                    return n;
                }),
                ...
                (this.I_StartPlayback = function (e, n) {
                    ...
                    if ((S.extend(l, n), -1 != r)) {
                        ...
                        if (ct()) {
                            ...
                            h == H && d.oStreamCapa.bSupportShttpPlay
                                ? ((s = U(l.oTransCodeParam)
                                    ? d.oProtocolInc.CGI.startShttpPlayback
                                    : d.oProtocolInc.CGI.startTransCodePlayback),
                                    (o = "http://"),
                                    (u = l.iStreamType - 1),
                                    (a =
                                        l.iChannelID <= d.iAnalogChannelNum
                                            ...
                                            d.iAnalogChannelNum -
                                            1),
                                    d.bSupportSubStreamPlayback && (a = 100 * a + u),
                                    U(l.iPort)
                                        ? "https://" == d.szHttpProtocol
                                            ? (-1 == d.iHttpPort && (d.iHttpPort = nt(d).iHttpPort),
                                                (i = d.iHttpPort))
                                            : (i = d.iCGIPort)
                                        : ((d.iHttpPort = l.iPort), (i = l.iPort)))
                                : ((s = d.oProtocolInc.CGI.startPlayback),
                                    (o = "rtsp://"),
                                    (u = l.iStreamType),
                                    (a = 100 * l.iChannelID + u),
                                    U(l.iRtspPort) || (d.iRtspPort = l.iRtspPort),
                                    -1 == d.iRtspPort && (d.iRtspPort = nt(d).iRtspPort),
                                    (i = d.iRtspPort));
                        }
                        if (-1 == i)
                            return N("获取端口号失败"), n.error && n.error(), void 0;
                        S.extend(l, { urlProtocol: o, cgi: s, iPort: i, iChannelID: a }),
                            (r = this.findWndIndexByIndex(l.iWndIndex)),
                            -1 == r &&
                            (ct()
                                ? ((l.szStartTime = l.szStartTime.replace(" ", "T") + "Z"),
                                    (l.szEndTime = l.szEndTime.replace(" ", "T") + "Z"),
                                    d.oProtocolInc.startPlayback(d, l).then(
                                        function () {
                                            n.success && n.success();
                                        },
                                        function () {
                                ...
                                : ((l.szStartTime =
                                    l.szStartTime.replace(/[-:]/g, "").replace(" ", "T") +
                                    "Z"),
                                    (l.szEndTime =
                                        l.szEndTime.replace(/[-:]/g, "").replace(" ", "T") +
                                        "Z"),
                                    d.oProtocolInc.startPlayback(d, l).then(
                                        function () {
                                            n.success && n.success();
                ...
                (this.I_ReversePlayback = function (e, n) {
                    ...
                    if ((S.extend(d, n), -1 != r)) {
                        ...
                        if (
                            (h == H && p.oStreamCapa.bSupportShttpPlay
                                ? ((o = p.oProtocolInc.CGI.startShttpReversePlayback),
                                    ...
                                    U(d.iPort)
                                        ? "https://" == p.szHttpProtocol
                                            ? (-1 == p.iHttpPort && (p.iHttpPort = nt(p).iHttpPort),
                                                (a = p.iHttpPort))
                                            : (a = p.iCGIPort)
                                ...
                                : ((o = p.oProtocolInc.CGI.startPlayback),
                                    (i = "rtsp://"),
                                    (c = d.iStreamType),
                                    (u = 100 * d.iChannelID + c),
                                    U(d.iRtspPort) || (p.iRtspPort = d.iRtspPort),
                                    -1 == p.iRtspPort && (p.iRtspPort = nt(p).iRtspPort),
                                    (a = p.iRtspPort)),
                                -1 == a)
                        )
                            return N("获取端口号失败"), s;
                        S.extend(d, { urlProtocol: i, cgi: o, iPort: a, iChannelID: u }),
                            (r = this.findWndIndexByIndex(d.iWndIndex)),
                            -1 == r &&
                            ((d.szStartTime =
                                d.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z"),
                                (d.szEndTime =
                                    d.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z"),
                                (s = p.oProtocolInc.reversePlayback(p, d)));
                    }
                ...
                (this.I_Frame = function (e) {
                    ...
                    if (-1 != n) {
                        ...
                        if (s == A || s == L)
                            if (ct())
                                p.JS_FrameForward(t.iWndIndex).then(
                                    function () {
                ...
                (this.I_GetOSDTime = function (e) {
                    ...
                    if (-1 != n) {
                        if (ct())
                            p.JS_GetOSDTime(t.iWndIndex).then(
                                function (e) {
                                    if (t.success) {
                                        var n = S.dateFormat(
                                            new Date(1e3 * e),
                ...
                (this.I_StartDownloadRecordByTime = function (e, t, n, r, s, o) {
                    ...
                    if (-1 != i) {
                        ...
                        t =
                            ...
                            s.replace(" ", "T") +
                            "Z";
                        var c = { szPlaybackURI: t, szFileName: n, bDateDir: !0 };
                        U(o) || S.extend(c, o),
                            (a = u.oProtocolInc.startDownloadRecord(u, c));
                    }
                    return a;
                }),
                (this.I_GetDownloadStatus = function (e) {
                    ...
                    return ct()
                        ? t
                        : ((t = p.HWP_GetDownloadStatus(e)), 1 == t && (t = -1), t);
                }),
                ...
                (this.I_RemoteConfig = function (e, t) {
                    ...
                    if ((S.extend(o, t), -1 != n)) {
                        ...
                        if (-1 == o.iDevicePort)
                            if (-1 == i.iDevicePort) {
                                if (
                                    ((i.iDevicePort = nt(i).iDevicePort),
                                        (s = i.iDevicePort),
                                        -1 == s)
                                )
                                    return r;
                        ...
                        if (":" == S.Base64.decode(i.szAuth)[0])
                            var a = S.Base64.decode(i.szAuth).split(":")[1],
                                u = S.Base64.decode(i.szAuth).split(":")[2];
                        else
                            var a = S.Base64.decode(i.szAuth).split(":")[0],
                ...
                (this.I_ChangeWndNum = function (e) {
                    return isNaN(parseInt(e, 10))
                        ? -1
                        : (ct() ? p.JS_ArrangeWindow(e) : p.HWP_ArrangeWindow(e), 0);
                }),
                ...
                (this.I_SetSnapDrawMode = function (e, t) {
                    return ct()
                        ? t > -1
                            ? p.JS_SetDrawStatus(!0)
                            : p.JS_SetDrawStatus(!1)
                        : p.HWP_SetSnapDrawMode(e, t);
                }),
                (this.I2_SetSnapPolygonInfo = function (r, s) {
                    if (ct()) {
                        ...
                        var o = S.loadXML(s),
                            a = [];
                        for (
                            nodeList = t.$XML(o).find("SnapPolygon", !0),
                            i = 0,
                            iLen = nodeList.length;
                            iLen > i;
                            i++
                        ) {
                            node = nodeList[i];
                            var u = e(
                                t.$XML(node).find("r").eq(0).text(),
                                t.$XML(node).find("g").eq(0).text(),
                                t.$XML(node).find("b").eq(0).text()
                            );
                            (u = n(u, 6)), (u = "#" + u);
                            for (
                                var c = [],
                                l = t.$XML(node).find("point", !0),
                                d = 0,
                                f = l.length;
                                f > d;
                                d++
                                ...
                                (oNodePoint = l[d]),
                                    c.push([
                                        500 * t.$XML(oNodePoint).find("x").eq(0).text(),
                                        300 * t.$XML(oNodePoint).find("y").eq(0).text(),
                                    ]);
                            a.push({
                                iPolygonType: 1,
                ...
                (this.I_SetSnapPolygonInfo = function (r, s) {
                    if (ct()) {
                        var o = p.JS_GetPolygonInfo(),
                            ...
                            a = [];
                        for (
                            D = t.$XML(i).find("SnapPolygon", !0), d = 0, f = D.length;
                            f > d;
                            d++
                        ) {
                            h = D[d];
                            var u = e(
                                t.$XML(h).find("r").eq(0).text(),
                                t.$XML(h).find("g").eq(0).text(),
                                t.$XML(h).find("b").eq(0).text()
                            );
                            (u = n(u, 6)),
                                (u = "#" + u),
                                a.push({
                                    ...
                                    style: { szDrawColor: u, iTranslucent: 0.1 },
                                });
                        }
                        0 === D.length &&
                            a.push({
                                ...
                                iMaxPointSupport: 17,
                                iMinPointSupport: 1,
                                style: { szDrawColor: "#FFFF00", iTranslucent: 0.1 },
                            });
                        var c = [];
                        $.each(o, function (e, t) {
                            c.push(t.id);
                    ...
                    var i,
                        ...
                        g,
                        x,
                        z = p.HWP_GetSnapPolygonInfo(r);
                    (i = S.loadXML(z)), (D = t.$XML(i).find("SnapPolygon", !0));
                    var b = D.length,
                        c = [];
                    for (d = 0, f = D.length; f > d; d++)
                        (h = D[d]), c.push(t.$XML(h).find("id").eq(0).text());
                    var l = c.join(",");
                    if (
                        ((l = "," + l + ","),
                            (i = S.loadXML(s)),
                            (D = t.$XML(i).find("SnapPolygon", !0)),
                            b + D.length > 32)
                    )
                        return -3;
                    for (d = 0, f = D.length; f > d; d++) {
                        if (
                            ((h = D[d]),
                                (P = t.$XML(h).find("id").eq(0).text()),
                                !S.isInt(P))
                        )
                            return -2;
                        if (((I = parseInt(P, 10)), 1 > I || I > 32)) return -2;
                        if (l.indexOf("," + P + ",") > -1) return -4;
                        if (((m = t.$XML(h).find("tips").eq(0).text()), m.length > 32))
                            return -2;
                        if (
                            ((v = "true" === t.$XML(h).find("isClosed").eq(0).text()), !v)
                        ) {
                            if (
                                ((C = t.$XML(h).find("MinClosed").eq(0).text()), !S.isInt(C))
                            )
                                return -2;
                            if (((y = parseInt(C, 10)), 4 > y || y > 17)) return -2;
                            if (
                                ((g = t.$XML(h).find("PointNumMax").eq(0).text()),
                                    !S.isInt(g))
                            )
                                return -2;
                ...
                (this.I_GetSnapPolygonInfo = function (e) {
                    if (ct()) {
                        for (
                            var t = p.JS_GetPolygonInfo(e),
                            n = '<?xml version="1.0" encoding="utf-8"?><SnapPolygonList>',
                            s = 0;
                            s < t.length;
                            s++
                        ) {
                            ...
                            n +=
                                "<id>" +
                                t[s].szTips.split("#")[1] +
                                "</id><polygonType>1</polygonType><color><r>" +
                                o[0] +
                                "</r><g>" +
                                o[1] +
                                "</g><b>" +
                                ...
                                t[s].bClosed +
                                "</isClosed><pointList>";
                            for (var i = 0; i < t[s].aPoint.length; i++)
                                n +=
                                    "<point><x>" +
                                    t[s].aPoint[i][0] / a +
                                    "</x><y>" +
                ...
                (this.I_DeviceCapturePic = function (e, t, n, r) {
                    ...
                    if (-1 != s) {
                        ...
                        if (
                            (S.extend(a, r),
                                !U(a.iResolutionWidth) && !S.isInt(a.iResolutionWidth))
                        )
                            return o;
                        if (!U(a.iResolutionHeight) && !S.isInt(a.iResolutionHeight))
                            return o;
            ...
            (Pt.prototype.m_httpRequestSet = []),
                (Pt.prototype.setRequestParam = function (e) {
                ...
                (Pt.prototype.submitRequest = function () {
                    ...
                    if (ct()) {
                        ...
                        if (this.options.async) {
                            ...
                            var c = p.HWP_SendHttpSynRequest(
                                a,
                                this.options.url,
                                this.options.auth,
                                this.options.data,
                ...
                (Pt.prototype.processCallback = function (e, t) {
                    ...
                    null != n && (this.httpDataAnalyse(n, t), n = null);
                }),
                    ...
                    "" == t || U(t)
                        ...
                        : ((r = parseInt(t.substring(0, 3))),
                            ...
                            isNaN(r)
                                ...
                                : z == r
                                    ? this.options &&
                                        this.options.url.indexOf("?format=json") > -1
                                        ? e.funSuccessCallback(JSON.parse(n))
                                        : e.funSuccessCallback(S.loadXML(n))
                                    : e.funErrorCallback && e.funErrorCallback(r, S.loadXML(n)));
                });
            var It = function () { };
            (It.prototype.CGI = {
                        ...
                        S.extend(o, {
                            success: function (e) {
                                ...
                                r.push("<DeviceInfo>"),
                                    r.push(
                                        "<deviceName>" +
                                        S.escape(t.$XML(e).find("deviceName").eq(0).text()) +
                                        "</deviceName>"
                                    ),
                                    r.push(
                                        "<deviceID>" +
                                        t.$XML(e).find("deviceID").eq(0).text() +
                                        "</deviceID>"
                                    ),
                                    r.push(
                                        "<deviceType>" +
                                        t.$XML(e).find("deviceType").eq(0).text() +
                                        "</deviceType>"
                                    ),
                                    r.push(
                                        "<model>" +
                                        t.$XML(e).find("model").eq(0).text() +
                                        "</model>"
                                    ),
                                    r.push(
                                        "<serialNumber>" +
                                        t.$XML(e).find("serialNumber").eq(0).text() +
                                        "</serialNumber>"
                                    ),
                                    r.push(
                                        "<macAddress>" +
                                        t.$XML(e).find("macAddress").eq(0).text() +
                                        "</macAddress>"
                                    ),
                                    r.push(
                                        "<firmwareVersion>" +
                                        t.$XML(e).find("firmwareVersion").eq(0).text() +
                                        "</firmwareVersion>"
                                    ),
                                    r.push(
                                        "<firmwareReleasedDate>" +
                                        t.$XML(e).find("firmwareReleasedDate").eq(0).text() +
                                        "</firmwareReleasedDate>"
                                    ),
                                    r.push(
                                        "<encoderVersion>" +
                                        t.$XML(e).find("encoderVersion").eq(0).text() +
                                        "</encoderVersion>"
                                    ),
                                    r.push(
                                        "<encoderReleasedDate>" +
                                        t.$XML(e).find("encoderReleasedDate").eq(0).text() +
                                        "</encoderReleasedDate>"
                                    ),
                                    r.push("</DeviceInfo>"),
                                    (e = S.loadXML(r.join(""))),
                            ...
                            success: function (r) {
                                ...
                                for (var i = 0, a = o.length; a > i; i++) {
                                    ...
                                    s.push("<VideoInputChannel>"),
                                        s.push(
                                            "<id>" + t.$XML(u).find("id").eq(0).text() + "</id>"
                                        ),
                                        s.push(
                                            "<inputPort>" +
                                            t.$XML(u).find("inputPort").eq(0).text() +
                                            "</inputPort>"
                                        ),
                                        s.push(
                                            "<name>" +
                                            S.escape(t.$XML(u).find("name").eq(0).text()) +
                                            "</name>"
                                        ),
                                        s.push(
                                            "<videoFormat>" +
                                            t.$XML(u).find("videoFormat").eq(0).text() +
                                            "</videoFormat>"
                                        ),
                                        s.push("</VideoInputChannel>");
                                }
                    ...
                    S.extend(o, n),
                        S.extend(o, {
                            success: function (e) {
                                ...
                                for (
                                    var s = t.$XML(e).find("InputProxyChannel", !0),
                                    o = 0,
                                    i = s.length;
                                    i > o;
                                    o++
                                    ...
                                    r.push("<InputProxyChannel>"),
                                        r.push(
                                            "<id>" + t.$XML(a).find("id").eq(0).text() + "</id>"
                                        ),
                                        r.push(
                                            "<name>" +
                                            S.escape(t.$XML(a).find("name").eq(0).text()) +
                                            "</name>"
                                        ),
                                        r.push("</InputProxyChannel>");
                                }
                    ...
                    if (
                        (this.getDigitalChannel(e, {
                            ...
                            success: function (e) {
                                r = e;
                                for (
                                    var n = t.$XML(r).find("InputProxyChannel", !0),
                                    o = 0,
                                    i = n.length;
                                    i > o;
                                    o++
                        ...
                        S.extend(a, n),
                            S.extend(a, {
                                success: function (e) {
                                    ...
                                    for (
                                        var o = t.$XML(e).find("InputProxyChannelStatus", !0),
                                        i = 0,
                                        a = o.length;
                                        a > i;
                                        i++
                                        ...
                                        r.push("<InputProxyChannelStatus>"),
                                            ...
                                            r.push(
                                                "<proxyProtocol>" +
                                                t.$XML(u).find("proxyProtocol").eq(0).text() +
                                                "</proxyProtocol>"
                                            ),
                                            r.push(
                                            ...
                                            r.push(
                                                "<ipAddress>" +
                                                t.$XML(u).find("ipAddress").eq(0).text() +
                                                "</ipAddress>"
                                            ),
                                            r.push(
                                                "<managePortNo>" +
                                                t.$XML(u).find("managePortNo").eq(0).text() +
                                                "</managePortNo>"
                                            ),
                                            r.push(
                                                "<srcInputPort>" +
                                                t.$XML(u).find("srcInputPort").eq(0).text() +
                                                "</srcInputPort>"
                                            ),
                                            r.push(
                                                "<userName>" +
                                                S.escape(t.$XML(u).find("userName").eq(0).text()) +
                                                "</userName>"
                                            ),
                                            r.push(
                                                "<streamType>" +
                                                t.$XML(u).find("streamType").eq(0).text() +
                                                "</streamType>"
                                            ),
                                            r.push(
                                                "<online>" +
                                                t.$XML(u).find("online").eq(0).text() +
                                                "</online>"
                                            ),
                                            r.push("<name>" + S.escape(s[c]) + "</name>"),
                                            r.push("</sourceInputPortDescriptor>"),
                                            r.push("</InputProxyChannelStatus>");
                                    }
                                    r.push("</InputProxyChannelStatusList>"),
                ...
                (It.prototype.startRealPlay = function (e, t) {
                    ...
                    if (
                        ("rtsp://" === t.urlProtocol && (o = V(o)),
                            t.bZeroChannel
                                ? (ct() && (n = 0),
                                    (r = F(t.cgi.zeroChannels, t.urlProtocol, o, t.iPort, n)))
                                : (r = F(t.cgi.channels, t.urlProtocol, o, t.iPort, n)),
                            d.proxyAddress && ct())
                    ) {
                        S.cookie("webVideoCtrlProxy", o + ":" + t.iPort, { raw: !0 }),
                            (r = F(
                                t.cgi.zeroChannels,
                                t.urlProtocol,
                                d.proxyAddress.ip,
                    ...
                    var a = function () {
                        ...
                        u = $.Deferred();
                    if (ct()) {
                        var c = { sessionID: e.szAuth, token: O(e, e.szDeviceIdentify) };
                        (r = dt(r)),
                            p.JS_Play(r, c, t.iWndIndex).then(
                                function () {
                                    a(), u.resolve();
                                },
                                function () {
                        ...
                        (s = p.HWP_Play(r, e.szAuth, t.iWndIndex, "", "")),
                            0 == s ? (a(), u.resolve()) : u.reject();
                    return u;
                }),
                ...
                (It.prototype.ptzControl = function (e, t, n, r) {
                    ...
                    o =
                        (u != this.CGI.ptzFocus && u != this.CGI.ptzIris) ||
                            ...
                            : F(u.ipc, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID);
                    var c = new Pt(),
                        l = {
                            type: "PUT",
                            url: o,
                ...
                (It.prototype.recordSearch = function (e, n) {
                    ...
                    S.extend(d, n),
                        S.extend(d, {
                            success: function (e) {
                                var r = [];
                                r.push("<CMSearchResult>"),
                                    r.push(
                                        "<responseStatus>" +
                                        t.$XML(e).find("responseStatus").eq(0).text() +
                                        "</responseStatus>"
                                    ),
                                    r.push(
                                        "<responseStatusStrg>" +
                                        t.$XML(e).find("responseStatusStrg").eq(0).text() +
                                        "</responseStatusStrg>"
                                    ),
                                    r.push(
                                        "<numOfMatches>" +
                                        t.$XML(e).find("numOfMatches").eq(0).text() +
                                        "</numOfMatches>"
                                    ),
                                    r.push("<matchList>");
                                for (
                                    var s = t.$XML(e).find("searchMatchItem", !0),
                                    o = 0,
                                    i = s.length;
                                    i > o;
                                    o++
                                    ...
                                    var a = s[o];
                                    r.push("<searchMatchItem>"),
                                        r.push(
                                            "<trackID>" +
                                            t.$XML(a).find("trackID").eq(0).text() +
                                            "</trackID>"
                                        ),
                                        r.push(
                                            "<startTime>" +
                                            t.$XML(a).find("startTime").eq(0).text() +
                                            "</startTime>"
                                        ),
                                        r.push(
                                            "<endTime>" +
                                            t.$XML(a).find("endTime").eq(0).text() +
                                            "</endTime>"
                                        ),
                                        r.push(
                                            "<playbackURI>" +
                                            S.escape(t.$XML(a).find("playbackURI").eq(0).text()) +
                                            "</playbackURI>"
                                        ),
                                        r.push(
                                            "<metadataDescriptor>" +
                ...
                (It.prototype.startPlayback = function (e, t) {
                    ...
                    if (("rtsp://" === t.urlProtocol && (i = V(i)), ct()))
                        if (d.proxyAddress) {
                            S.cookie("webVideoCtrlProxy", i + ":" + t.iPort, { raw: !0 }),
                                (r = F(
                                    t.cgi,
                                    t.urlProtocol,
                                    d.proxyAddress.ip,
                            ...
                            r = F(t.cgi, t.urlProtocol, i, t.iPort, t.iChannelID, s, o);
                    ...
                    var c = function () {
                        ...
                        l = $.Deferred();
                    if (ct()) {
                        var f = { sessionID: e.szAuth, token: O(e, e.szDeviceIdentify) };
                        p.JS_Play(r, f, n, s, o).then(
                            function () {
                                c(), l.resolve();
                            },
                            function () {
                ...
                (It.prototype.startDownloadRecord = function (e, t) {
                    var n = -1,
                        ...
                        s =
                            ...
                            S.escape(t.szPlaybackURI) +
                            "</playbackURI>" +
                            "</downloadRequest>";
                    return (
                        ct()
                            ? ((r = lt(r)),
                                (n = p.JS_StartDownload(r, e.szAuth, t.szFileName, s)))
                            : (n = p.HWP_StartDownload(
                                r,
                                e.szAuth,
                                t.szFileName,
                                s,
                ...
                (It.prototype.exportDeviceConfig = function (e, t) {
                    ...
                    if (ct()) {
                        ...
                        return (
                            ...
                            s.submitRequest(),
                            (n = lt(n)),
                            t && (n = S.exportPasswordDeviceConfig(n, t)),
                            p.JS_ExportDeviceConfig(n)
                        );
                    }
                    return (
                        t && (n = S.exportPasswordDeviceConfig(n, t)),
                        p.HWP_ExportDeviceConfig(n, e.szAuth, "", 0)
                    );
                }),
                (It.prototype.importDeviceConfig = function (e, t, n) {
                    ...
                    if (ct()) {
                        ...
                        return (
                            ...
                            o.submitRequest(),
                            (r = lt(r)),
                            n && (r = S.exportPasswordDeviceConfig(r, n)),
                            p.JS_UploadFile(r)
                        );
                    }
                    return (
                        n && (r = S.exportPasswordDeviceConfig(r, n)),
                        p.HWP_ImportDeviceConfig(r, e.szAuth, t.szFileName, 0)
                    );
                }),
                ...
                (It.prototype.deviceCapturePic = function (e, t, n, r) {
                    var t = 100 * t + 1,
                        ...
                        i = [];
                    if (
                        (S.isInt(r.iResolutionWidth) &&
                            i.push("videoResolutionWidth=" + r.iResolutionWidth),
                            S.isInt(r.iResolutionHeight) &&
                ...
                (It.prototype.getSessionV2Cap = function (e, t, n, r, s, o) {
                    ...
                    a = a + "&random:" + e;
                    var u = new Pt(),
                        c = { type: "GET", url: a, auth: "", success: null, error: null };
                    S.extend(c, o),
                        S.extend(c, {
                            success: function (e) {
                ...
                (It.prototype.getSessionCap = function (e, t, n, r, s) {
                    ...
                    var i = F(this.CGI.sessionCap, o, e, n, encodeURIComponent(r)),
                        a = new Pt(),
                        u = { type: "GET", url: i, auth: "", success: null, error: null };
                    S.extend(u, s),
                        S.extend(u, {
                            success: function (e) {
                                s.success && s.success(e);
                ...
                (It.prototype.sessionV2Login = function (e, n, r, s, o, i, a, u) {
                    ...
                    c = 2 == r ? "https://" : "http://";
                    var l = parseInt(
                        t.$XML(a).find("sessionIDVersion").eq(0).text(),
                        10
                    ),
                        d =
                            "true" ===
                            t.$XML(a).find("isSessionIDValidLongTerm").eq(0).text(),
                        ...
                        I = !1,
                        m = "";
                    t.$XML(a).find("isIrreversible", !0).length > 0 &&
                        ((I = "true" === t.$XML(a).find("isIrreversible").eq(0).text()),
                            (m = t.$XML(a).find("salt").eq(0).text())),
                        (this.m_oInfoForLocalPlgin = {
                            szRandom: e,
                            sessionID: f,
                            iterations: P,
                            challenge: h,
                    ...
                    var v = S.encodePwd(
                        i,
                        { challenge: h, userName: o, salt: m, iIterate: P },
                        I
                    ),
                        C = "<SessionLogin>";
                    (C += "<userName>" + S.escape(o) + "</userName>"),
                        (C += "<password>" + v + "</password>"),
                        (C += "<sessionID>" + f + "</sessionID>"),
                        (C +=
                            "<isSessionIDValidLongTerm>" +
                            d +
                            "</isSessionIDValidLongTerm>"),
                        (C += "<sessionIDVersion>" + l + "</sessionIDVersion>"),
                        (C += "</SessionLogin>");
                    var y = new Pt(),
                        g = {
                            type: "POST",
                ...
                (It.prototype.sessionLogin = function (e, n, r, s, o, i, a) {
                    ...
                    var c = F(this.CGI.sessionLogin, u, e, r),
                        ...
                        f = !1,
                        h = "";
                    t.$XML(i).find("isIrreversible", !0).length > 0 &&
                        ((f = "true" === t.$XML(i).find("isIrreversible").eq(0).text()),
                            (h = t.$XML(i).find("salt").eq(0).text()));
                    var P = "";
                    if (f) {
                    ...
                    var m = "<SessionLogin>";
                    (m += "<userName>" + S.escape(s) + "</userName>"),
            ...
            (mt.prototype.CGI = {
                ...
                (mt.prototype.login = function (e, n, r, s) {
                    var o = 2 == s.protocol ? "https://" : "http://",
                        ...
                        a = new Pt(),
                        u = { type: "GET", url: i, auth: r, success: null, error: null };
                    S.extend(u, s),
                        S.extend(u, {
                            success: function (e) {
                                "200" == t.$XML(e).find("statusValue").eq(0).text()
                                    ? s.success && s.success(e)
                        ...
                        S.extend(o, {
                            success: function (e) {
                                ...
                                r.push("<DeviceInfo>"),
                                    ...
                                    r.push(
                                        "<deviceType>" +
                                        t.$XML(e).find("deviceDescription").eq(0).text() +
                                        "</deviceType>"
                                    ),
                                    r.push(
                                        "<model>" +
                                    ...
                                    r.push(
                                        "<encoderVersion>" +
                                        t.$XML(e).find("logicVersion").eq(0).text() +
                                        "</encoderVersion>"
                                    ),
                                    r.push(
                                        "<encoderReleasedDate>" +
                                        t.$XML(e).find("logicReleasedDate").eq(0).text() +
                                        "</encoderReleasedDate>"
                                    ),
                                    r.push("</DeviceInfo>"),
                                    (e = S.loadXML(r.join(""))),
                    ...
                    S.extend(o, n),
                        S.extend(o, {
                            success: function (e) {
                                ...
                                for (
                                    var s = t.$XML(e).find("VideoInputChannel", !0),
                                    o = 0,
                                    i = s.length;
                                    i > o;
                                    o++
                                    ...
                                    r.push("<VideoInputChannel>"),
                                        ...
                                        r.push(
                                            "<inputPort>" +
                                            t.$XML(a).find("inputPort").eq(0).text() +
                                            "</inputPort>"
                                        ),
                                        r.push(
                                            "<name>" +
                                        ...
                                        r.push(
                                            "<videoFormat>" +
                                            t.$XML(a).find("videoFormat").eq(0).text() +
                                            "</videoFormat>"
                                        ),
                                        r.push("</VideoInputChannel>");
                                }
                    ...
                    S.extend(o, n),
                        S.extend(o, {
                            success: function (e) {
                                ...
                                r.push("<InputProxyChannelList>");
                                for (
                                    var s = t.$XML(e).find("DynVideoInputChannel", !0),
                                    o = 0,
                                    i = s.length;
                                    i > o;
                                    o++
                        ...
                        S.extend(a, n),
                            S.extend(a, {
                                success: function (e) {
                                    ...
                                    r.push("<InputProxyChannelStatusList>");
                                    for (
                                        var o = t.$XML(e).find("DynVideoInputChannelStatus", !0),
                                        i = 0,
                                        a = o.length;
                                        a > i;
                                        i++
                                        ...
                                        r.push("<InputProxyChannelStatus>"),
                                            ...
                                            r.push(
                                                "<proxyProtocol>" +
                                                t.$XML(u).find("adminProtocol").eq(0).text() +
                                                "</proxyProtocol>"
                                            ),
                                            r.push(
                                                "<addressingFormatType>" +
                                            ...
                                            r.push(
                                                "<managePortNo>" +
                                                t.$XML(u).find("adminPortNo").eq(0).text() +
                                                "</managePortNo>"
                                            ),
                                            r.push(
                                                "<srcInputPort>" +
                    ...
                    S.extend(o, n),
                        S.extend(o, {
                            success: function (r) {
                                ...
                                for (
                                    var o = t.$XML(r).find("AdminAccessProtocol", !0),
                                    i = 0,
                                    a = o.length;
                                    a > i;
                                    i++
                                    ...
                                    o[i],
                                        ...
                                        s.push(
                                            "<id>" + t.$XML(r).find("id").eq(0).text() + "</id>"
                                        ),
                                        s.push(
                                            "<enabled>" +
                                            t.$XML(r).find("enabled").eq(0).text() +
                                            "</enabled>"
                                        ),
                                        s.push(
                                            "<protocol>" +
                                ...
                                C.getStreamChannels(e, {
                                    ...
                                    success: function (r) {
                                        if (t.$XML(r).find("rtspPortNo", !0).length > 0) {
                                            var o = parseInt(
                                                t.$XML(r).find("rtspPortNo").eq(0).text(),
                                                10
                                            );
                                            s.push("<AdminAccessProtocol>"),
                                                s.push("<id>4</id>"),
                                            ...
                                            C.getStreamDynChannels(e, {
                                                async: !1,
                                                success: function (e) {
                                                    if (t.$XML(e).find("rtspPortNo", !0).length > 0) {
                                                        var r = parseInt(
                                                            t.$XML(e).find("rtspPortNo").eq(0).text(),
                                                            10
                                                        );
                                                        s.push("<AdminAccessProtocol>"),
                                                            s.push("<id>4</id>"),
                                    ...
                                    C.getStreamChannels(e, {
                                        ...
                                        success: function (s) {
                                            if (t.$XML(s).find("rtspPortNo", !0).length > 0) {
                                                var o = parseInt(
                                                    t.$XML(s).find("rtspPortNo").eq(0).text(),
                                                    10
                                                );
                ...
                (mt.prototype.startRealPlay = function (e, t) {
                    var n = 100 * t.iChannelID + t.iStreamType,
                        r = "",
                        s = e.szIP;
                    "rtsp://" === t.urlProtocol && (s = V(s)),
                        (r = t.bZeroChannel
                            ? F(t.cgi.zeroChannels, t.urlProtocol, s, t.iPort, n)
                            : F(t.cgi.channels, t.urlProtocol, s, t.iPort, n));
                ...
                (mt.prototype.deviceCapturePic = function (e, t, n, r) {
                    ...
                    return (
                        ...
                        o.length > 0 && (s += "?" + o.join("&")),
                        p.HWP_DeviceCapturePic(s, e.szAuth, n, r.bDateDir)
                    );
                });
            var vt = function () { };
            ...
            (Ct.prototype.extend = function () {
                ...
                (Ct.prototype.encodePwd = function (e, t, n) {
                    var r = "";
                    if (n) {
                        (r = S.sha256(t.userName + t.salt + e)),
                            (r = S.sha256(r + t.challenge));
                ...
                (Ct.prototype.Base64 = {
                    ...
                    encode: function (e) {
                        var t,
                            ...
                            u = "",
                            c = 0;
                        for (e = Ct.prototype.Base64._utf8_encode(e); c < e.length;)
                            (t = e.charCodeAt(c++)),
                                (n = e.charCodeAt(c++)),
                                (r = e.charCodeAt(c++)),
                                (s = t >> 2),
                            ...
                            128 > r
                                ...
                                : r > 127 && 2048 > r
                                    ...
                                    : ((t += String.fromCharCode(224 | (r >> 12))),
                                        (t += String.fromCharCode(128 | (63 & (r >> 6)))),
                                        (t += String.fromCharCode(128 | (63 & r))));
                        }
                        return t;
                    },
                ...
                (Ct.prototype.encodeAES = function (e, t, n, r) {
                    var s = "";
                    if ("ecb" === r)
                        for (var o = e.length, i = 0; o > 0;)
                            (s +=
                                o > 16
                                    ? aes_encrypt(e.substring(i, i + 16), t, !0)
                                    : aes_encrypt(e.substring(i), t, !0)),
                                (o -= 16),
                                (i += 16);
                    else {
                        "undefined" == typeof n &&
                            (n = "6cd9616beb39d4034fdebe107df9a399");
                ...
                (o.prototype.createUUID = function () {
                    var e = new Date(1582, 10, 15, 0, 0, 0, 0),
                        ...
                        l =
                            ...
                            o.getIntegerBits(o.rand(8191), 8, 15) +
                            o.getIntegerBits(o.rand(8191), 0, 7) +
                            o.getIntegerBits(o.rand(8191), 8, 15) +
                            o.getIntegerBits(o.rand(8191), 0, 15);
                ...
                (o.getIntegerBits = function (e, t, n) {
                    ...
                    for (a = Math.floor(t / 4); a <= Math.floor(n / 4); a++)
                        i += s[a] && "" != s[a] ? s[a] : "0";
                    return i;
                }),
