...
cacheController = APIRouter(prefix="/monitor/cache", tags=["缓存监控"])
...
@cacheController.delete(
    "/clearCacheKey/{cache_name}/{cache_key}", dependencies=[Depends(CheckUserInterfaceAuth("monitor:cache:list"))]
)
