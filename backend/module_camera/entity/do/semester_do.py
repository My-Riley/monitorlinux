...
class SysSemester(Base):
    __tablename__ = "sys_semester"
    __table_args__ = {"comment": "学期表"}

    id = Column(String(32), primary_key=True, nullable=False, comment="学期ID")
    name = Column(String(128), nullable=False, comment="学期名称")
    start_date = Column(Date, nullable=False, comment="开始日期")
    end_date = Column(Date, nullable=False, comment="结束日期")
    weeks = Column(Integer, nullable=False, default=20, comment="总周数")
